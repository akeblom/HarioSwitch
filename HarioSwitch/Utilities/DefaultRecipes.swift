...
struct DefaultRecipes {
    static func seedIfNeeded(context: ModelContext) {
        ...
        let basicImmersion = Recipe(name: "Basic Immersion", coffeeGrams: 20, waterML: 240, steps: [
            ...
            BrewStep(sortIndex: 2, durationSeconds: 60, actionType: .steep, switchPosition: .open),
        ])
        ...
        let kasuyaDevilSwitch = Recipe(name: "Kasuya Devil Switch", coffeeGrams: 20, waterML: 280, steps: [
            ...
            BrewStep(sortIndex: 4, durationSeconds: 90, actionType: .steep, switchPosition: .open),
        ])

        let hybridPourOver = Recipe(name: "Hybrid Pour Over", coffeeGrams: 20, waterML: 300, steps: [
            BrewStep(sortIndex: 0, durationSeconds: 30, actionType: .pour, switchPosition: .closed, waterML: 60),
            ...
            BrewStep(sortIndex: 5, durationSeconds: 60, actionType: .steep, switchPosition: .open),
        ])
